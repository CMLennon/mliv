...
# echo -e "F2\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R F 1 1000 1000 F 2 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"


# Non-Belloni (type 3)
# echo -e "F5\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R F 1 1000 1000 F 5 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"

# Belloni (type 3 noise)
# echo -e "T3-1\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R T 1 1000 1000 F 3 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"

# # Non-Belloni (type 4 noise)
# echo -e "F4\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R F 1 1000 1000 F 4 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"

# # Belloni (type 1 noise)
# echo -e "T1-1\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R F 1 1000 1000 F 1 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"

# #Belloni (type 2 noise)
# echo -e "T2-1\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R F 1 1000 1000 F 2 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"
...
# echo -e "T3-1\n\nStarted: \n$(date +'%r\n%D')\n"
# time Rscript --vanilla codeR/nonlinear-results-new.R F 1 1000 1000 F 3 rf rfcv pca gboost JIVE LIML lasso plasso
# echo -e "Ended: \n$(date +'%r\n%D')\n\n"
