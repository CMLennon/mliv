...
if (original == TRUE){
  ...
  cvparams = gridsearch(dt = i_dt_corr_test, fnum = 5, mod_form = form)
  #print(cvparams)
...
sim_dt <- run_sim(n = 1e3, n_sims = 350)
