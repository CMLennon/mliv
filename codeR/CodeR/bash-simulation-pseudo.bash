...
# Belloni type 1
echo -e "T1\n\nStarted: \n$(date +'%r\n%D')\n"
time Rscript --vanilla codeR/bash-friendly-sim-pseudo-nonlinear.R T 1 1000 1000 F
echo -e "Ended: \n$(date +'%r\n%D')\n\n"

# Belloni type 2
echo -e "T2\n\nStarted: \n$(date +'%r\n%D')\n"
time Rscript --vanilla codeR/bash-friendly-sim-pseudo-nonlinear.R T 2 1000 1000 F
echo -e "Ended: \n$(date +'%r\n%D')\n\n"

# Belloni type 3
#echo -e "T3\n\nStarted: \n$(date +'%r\n%D')\n"
#time Rscript --vanilla codeR/bash-friendly-sim-pseudo-nonlinear.R T 3 1000 #1000 F
#echo -e "Ended: \n$(date +'%r\n%D')\n\n"
